  ...
  return <section className="flex min-h-[500px] flex-col overflow-hidden rounded-[26px] border border-black/[0.07] bg-white shadow-sm lg:min-h-0"
    ...
    <div className="border-b border-black/[0.07] px-6 py-5">
      ...
      <p className="mt-2 text-xs leading-5 text-[#777780]">
        {aiReady
          ? "Comenzile uzuale de design sunt gratuite. AI-ul este folosit numai pentru cereri creative pe care motorul local nu le poate rezolva."
          : "Motorul local schimbă gratuit culori, layout, mărimea titlului și texte oferite explicit."}
      </p>
    ...
    <div className="border-t border-black/[0.07] p-4">
      <div className="mb-3 flex flex-wrap gap-2">
        {["Fă site-ul negru cu accent auriu", "Vreau un titlu mare", "Schimbă layoutul în centrat"].map(example =>
      ...
      <form onSubmit={onSend} className="rounded-[20px] border border-black/10 bg-[#f7f7fa] p-2">
        ...
        <textarea id="editor-prompt" value={prompt} maxLength={600} rows={3}
          ...
          placeholder={aiReady ? "Ex.: Negru cu auriu sau rescrie titlul..." : "Ex.: Negru cu auriu, titlu mare sau Titlu: textul tău (gratuit)."}
