...
import EstimateMaterialRequirements from "@/components/modules/EstimateMaterialRequirements";
      ...
      <section className="mt-5 grid gap-4 xl:grid-cols-[0.9fr_1.1fr]">
        ...
        <div data-workspace-record-focus={initialRecordId && selected?.id === initialRecordId ? "true" : undefined} className="scroll-mt-28 rounded-[28px] border border-[var(--border)] bg-[var(--surface-2)] p-5 sm:p-7">
          {selected ? <>
            ...
            <EstimateMaterialRequirements key={selected.id} organizationId={organizationId} estimateId={selected.id} estimateItems={items} canWrite={canWrite} locale={locale} />
