...
- Additive commercial-issuer snapshot migration applied and verified in live Supabase on 25.09.2026 (migration ID `20260925105411`). New checkout remains fail-closed by default; do not activate production Stripe/Oblio billing until every listed legal, fiscal and operational gate closes. Existing 19 historic migration entries still require a separately verified repository baseline.
