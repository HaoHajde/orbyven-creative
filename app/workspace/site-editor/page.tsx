...
export default function SiteEditorPage(){
  ...
  return <main className="min-h-screen bg-[#f7f7fa] text-[#1d1d1f] antialiased">
    ...
    <div className="mx-auto grid max-w-[1680px] gap-4 p-3 md:p-5 lg:h-[calc(100vh-83px)] lg:grid-cols-[minmax(300px,390px)_minmax(0,1fr)]">
      <SiteEditorChat messages={editor.messages} prompt={editor.prompt} onPrompt={editor.setPrompt} onSend={editor.send} busy={editor.busy} error={editor.error} notice={editor.notice} aiStatus={editor.aiStatus} aiStatusReason={editor.aiStatusReason}/>
