...
export const metadata: Metadata = {
  title: "RITM Movement Club · Pilot #012 | ORBYVEN",
  description: "Fitness cu clase și abonamente simulate.",
  robots: { index: false, follow: false },
};

export default function Pilot012DemoPage() {
  return (
    <main className="fixed inset-0 bg-[#0b0b0d]">
      <iframe
        title="RITM Movement Club — demo interactiv ORBYVEN"
        src="/orbyven-demos/pilot-012/index.html"
