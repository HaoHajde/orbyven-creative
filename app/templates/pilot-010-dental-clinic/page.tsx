...
export const metadata: Metadata = {
  title: "LUMEN. Atelier Dentar · Pilot #010 | ORBYVEN",
  description: "Cabinet stomatologic fictiv cu servicii și programări demonstrative.",
  robots: { index: false, follow: false },
};

export default function Pilot010DemoPage() {
  return (
    <main className="fixed inset-0 bg-[#0b0b0d]">
      <iframe
        title="LUMEN. Atelier Dentar — demo interactiv ORBYVEN"
        src="/orbyven-demos/pilot-010/index.html"
