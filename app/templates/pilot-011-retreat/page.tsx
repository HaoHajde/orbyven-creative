...
export const metadata: Metadata = {
  title: "SENIN Retreat · Pilot #011 | ORBYVEN",
  description: "Boutique hotel cu camere, prețuri și rezervări fictive.",
  robots: { index: false, follow: false },
};

export default function Pilot011DemoPage() {
  return (
    <main className="fixed inset-0 bg-[#0b0b0d]">
      <iframe
        title="SENIN Retreat — demo interactiv ORBYVEN"
        src="/orbyven-demos/pilot-011/index.html"
