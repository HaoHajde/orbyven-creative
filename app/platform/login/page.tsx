...
export default function PlatformLoginPage() {
  ...
  useEffect(() => {
    const checkSession = async () => {
      ...
      if (data.user) router.replace("/platform");
    };
    checkSession();
  }, [router]);
          ...
          <div className="w-full max-w-[460px]">
            <div className="mb-8 text-center">
              ...
              <p className="mx-auto mt-5 max-w-sm text-sm leading-6 text-[#6e6e73] dark:text-[#a1a1a6]">
                Intră în spațiul companiei tale și folosește doar modulele de care ai nevoie.
              </p>
            </div>
            ...
            >
              ...
              <button
                type="submit"
                disabled={loading}
                className="mt-6 inline-flex h-12 w-full items-center justify-center rounded-full bg-[#1d1d1f] px-5 text-sm font-medium text-white transition-opacity disabled:opacity-60 dark:bg-[#f5f5f7] dark:text-black"
              >
