-- ORBYVEN workspace integration
-- The live Supabase project already contains the multi-tenant foundation created by:
...
--
-- This migration adds the controlled onboarding RPC used by /workspace/onboarding.
