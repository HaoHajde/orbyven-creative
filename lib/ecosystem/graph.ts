...
export const ECOSYSTEM_NODES: readonly EcosystemNode[] = [
  ...
  { id: "material_requirements", label: "Necesar materiale", table: "sales_material_requirements", workspaceModule: null, requires: ["estimate"], availability: "database_only", description: "Cantitate, unitate, cost, furnizor și status comandă legate de deviz." },
  { id: "client_offer", label: "Ofertă pentru client", table: "sales_commercial_documents", workspaceModule: null, requires: ["estimate", "crm"], availability: "database_only", description: "Document comercial de tip offer, cu snapshot separat de devizul editabil." },
  { id: "invoice_draft", label: "Ciornă factură", table: "sales_commercial_documents", workspaceModule: null, requires: ["client_offer", "crm"], availability: "database_only", description: "Tip invoice_draft; NU este factură fiscală emisă." },
