...
Runs on PR changes and ownership-label changes. It is intentionally conservative and only enforces domain path boundaries when a `chat-*` ownership label is present.
